...
<body>
    ...
    <div class="rightinfo">
        ...
        <div class="tools">
            <ul class="toolbar">
                <li class=""><a href="<?php echo U('addType');?>"><span><img src="/jiadianshop/Public/Admin/images/t01.png"></span>添加</a></li>
            </ul>
        </div>
        ...
        <table class="tablelist">
            ...
            <tbody>
                <!-- 品牌遍历区 -->
                <?php foreach ($typeData as $key => $type): ?>
                <tr data-id="<?php echo ($type["type_id"]); ?>">
                    ...
                    <td>
                        <a href="<?php echo U('Admin/Goods/attributeList',array('type_id'=>$type['type_id']));?>" class="tablelink">属性管理</a>
                        <a href="<?php echo U('editType',array('type_id'=>$type['type_id']));?>" class="tablelink">编辑</a>
                        <a href="javascript:;" class="tablelink click" onclick="document.getElementById('data_id').setAttribute('data-id',<?php echo ($type['type_id']); ?>)"> 删除</a>
                    </td>
                </tr>
                <?php endforeach ?>
                <!-- 品牌遍历区 -->
