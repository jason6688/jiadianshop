...
<body class="sarchbody">
    ...
    <div class="rightinfo">
        ...
        <tr data-id="<?php echo ($goods["id"]); ?>">
            ...
            <td><a href="#"><?php echo ($goods["goods_name"]); ?></a><p><?php echo ($goods["pro_info"]); ?></p></td>
            ...
            <td>
                <a href="<?php echo U('recover',array('goods_id'=>$goods['goods_id']));?>">【还原】</a>
        ...
        <div class="tip">
          ...
          <div class="tipinfo">
            ...
            <div class="tipbtn">
            <input name="" id="data_id" data-id="" type="button" onclick="window.location.href='<?php echo U('deleteGoods');?>?goods_id='+this.getAttribute('data-id')"  class="sure" value="确定" />&nbsp;
