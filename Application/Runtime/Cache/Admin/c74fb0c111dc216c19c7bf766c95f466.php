...
<body>
    ...
    <form action="<?php echo U('addGoodsAct');?>" method="post" enctype="multipart/form-data">
        ...
        <!-- <div class="formtext">Hi，<b>admin</b>，欢迎您试用信息发布功能！</div> -->
            <ul class="forminfo">
                ...
                <li>
                    ...
                    <input name="goods_name" type="text" id="goods_title" class="dfinput" placeholder="请填写商品名称"  style="width:518px;"/>
                ...
                <li>
                    <label>商品卖点</label>
                    <input name="selling_points" type="text" class="dfinput" placeholder="商品卖点"  style="width:518px;"/>
                ...
                <li>
                    <label>库存<b>*</b></label>
                    <input name="goods_number" type="text" class="dfinput" placeholder="请填写商品库存"/>
                </li>
				<li>
        ...
        <div id="tab3" class="tabson">
            <ul class="forminfo">
                ...
                <li>
                    <label>商品关键字</label>
                    <input type="text" name="key_words" class="dfinput" style="width:500px;" />
                    <i>用于seo优化, 多个用逗号隔开</i>
                </li>
                <li>
                    <label>商品简单描述</label>
