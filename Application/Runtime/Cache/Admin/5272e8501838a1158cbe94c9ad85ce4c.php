...
<body>
    ...
    <form action="<?php echo U('editAct');?>" method="post" enctype="multipart/form-data">
        <div class="formbody">
            ...
            <ul class="forminfo">
                ...
                <li><label>广告位置<b>*</b></label>
                    <select name="ad_pos_id" id="" class="dfinput">
                        <option value="">请选择...</option>
                        <option value="<?php echo ($ad['ad_pos_id']); ?>" selected><?php echo ($ad['name']); ?>&nbsp;&nbsp;<?php echo ($ad['width']); ?> X <?php echo ($ad['height']); ?></option>

                        <?php foreach ($ad_pos_list as $key => $ad_pos): ?>
                        <option value="<?php echo ($ad_pos["id"]); ?>" <?php echo $ad_pos['id']==$ad['ad_pos_id']?'selected':''; ?> ><?php echo ($ad_pos["name"]); ?>&nbsp;&nbsp;<?php echo ($ad_pos["width"]); ?> X <?php echo ($ad_pos["height"]); ?></option>
                        <?php endforeach ?>
                    </select>
                </li>

                <!-- 广告标题 -->
                <li><label>广告标题</label><input name="title" type="text" value="<?php echo ($ad["title"]); ?>" class="dfinput" /><i></i></li>

                <!-- 原广告图片 -->
                <li>
                    <label>原广告图片</label>
                    <img src="<?php echo ($ad["image"]); ?>" id="old_img" height="80" alt="" />
                </li>
                ...
                <!-- 广告url -->
                <li><label>广告url<b>*</b></label><input name="url" value="<?php echo ($ad["url"]); ?>" type="text" class="dfinput" /><i></i></li>
                ...
                <li><label>广告时间<b>*</b></label>
                    <input type="text" placeholder="请输入开始日期" value="<?php echo (date('Y/m/d H:i:s',$ad["start_time"])); ?>" name="start_time" id="start_time" class="laydate-icon" style="height:33px;"/>
                    <input type="text" placeholder="请输入结束日期" value="<?php echo (date('Y/m/d H:i:s',$ad["end_time"])); ?>" name="end_time" id="end_time" class="laydate-icon" style="height:33px;"/>
                </li>

                <!-- 广告联系人 -->
                <li><label>联系人</label>
                    <input type="text" name="linkman" value="<?php echo ($ad["linkman"]); ?>" class="dfinput" />
                </li>

                <!-- 广告联系人 -->
                <li><label>联系人邮箱</label>
                    <input type="text" name="linkman_email" value="<?php echo ($ad["linkman_email"]); ?>" class="dfinput" />
                </li>

                <!-- 广告联系人电话 -->
                <li><label>联系人电话</label>
                    <input type="text" name="linkman_tel" value="<?php echo ($ad["linkman_tel"]); ?>" class="dfinput" />
                </li>
