						...
						<?php if(is_array($vo['goods'])): $i = 0; $__LIST__ = $vo['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tal">
                                <div class="pro-area clearfix">
                                    <p class="p-img">
                                    	...
                                    	<img alt="<?php echo ($goods['goods_name']); ?>" src="<?php echo ($goods["goods_pic"]); ?>">
                                        
                                    	</a>
                                    </p>
                                    <p class="p-name">
                                    	<a title="<?php echo ($goods["goods_name"]); ?>" target="_blank" href="<?php echo U('Product/index',array('g'=>$goods['goods_id']));?>"><?php echo ($goods["goods_name"]); ?></a>
                                    </p>
                            ...
                            <td class="tr-span-2"><?php echo ($goods["goods_num"]); ?></td>
								...
								<td rowspan="2" class="tr-span-4 operate">
									  <?php if($vo['order_status'] == 0): ?><a href="<?php echo U('OrderPayment/index',array('order_id'=>$vo['order_id']));?>">去付款</a>
