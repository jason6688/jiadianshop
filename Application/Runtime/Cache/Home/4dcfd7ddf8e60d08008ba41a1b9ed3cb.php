                        ...
                        <tr>
                            ...
                            <td>
								<div id="myAddress-add-region" style="height:25px; float:left;">
								 ...
								 <script type="text/javascript" src="/jiadianshop/Public/Js/area.js"></script>
								</div>
...
<div class="mc-menu-area">
	<div class="h"><a href="/jiadianshop/member?t=1409801521486" class="button-go-mc" title="个人中心"><span>个人中心</span></a></div>
    <div class="b">
        <ul>
        	<li>
        	<h3>订单中心</h3>
            ...
            <h3>个人中心</h3>
            	<ol>
                    ...
                    <li id="li-myAddress" class="current"><a href="<?php echo U('PersonCenter/address');?>" title="收货信息"><span>收货信息</span></a></li>
