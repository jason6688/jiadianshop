...
<div class="layout">
    ...
    <div class="order-confirm" id="order-confirm-detail" style="height:300px">
		<div class="h" style="height:200px">
			...
			<p>订单号：&nbsp;&nbsp;<?php echo ($order_no); ?>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;    付款金额（元）：&nbsp;&nbsp;<b><?php echo (number_format($order_total_money,"2")); ?></b>&nbsp;<b>元</b></p>
			
			
		 
			<a  id="go_play" title="继续逛逛" href="<?php echo U('Index/index');?>" class="button-style-4 button-walking">
			         继续逛逛&nbsp;&gt;&gt;
			</a>
