...
<script type="text/javascript" src="/jiadianshop/Public/Js/jquery.cookie.js"></script>
<script type="text/javascript">
    $(function(){
    ...
    <div class="sc-area">
                ...
                <div class="b">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                <th>商品</th>
								<th class="tr-span-3" style="width:100px;">销售属性</th>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tbody>
						<tr>
							<td class="tal">
								<ul class="pro-area-2">
									<div style="width:50px;height:50px;float:left;"><img style="width:50px;height:50px;float:left;" src="<?php echo ($vo["goods_thumb_img"]); ?>"/></div><li style="height:50px;"><a style="line-height:50px;float:left;" href="">&nbsp;&nbsp;&nbsp;<?php echo ($vo["goods_name"]); ?></a></li>
								</ul>
							</td>
							<td class="tr-span-3" style="width:100px;"><?php echo ($vo["order_attr"]); ?></td>
							<td class="tr-span-3">&yen;<?php echo (number_format($vo["market_price"],2)); ?></td>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tar">
                            	优惠金额：<em>- &yen; 
                                <span id="order-discountTotalPrice" data-oldVal="0.00"><?php echo ($total_save_money); ?></span></em>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="order-action-area tar">
            ...
            <a href="<?php echo U('insert',array('goods_id'=>$goods_id,'num'=>$num,'order_attr'=>$order_attr));?>"  class="button-style-1 button-submit-order " title="提交订单" seed="checkout-submit"><span>提交订单</span></a>
        </div>
    </div>
</div>
<div class="hr-60"></div>
