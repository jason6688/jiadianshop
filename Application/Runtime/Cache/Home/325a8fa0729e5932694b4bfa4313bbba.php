    ...
    <div class="order-payment-list" id="order-payment-list">
		...
		<dd>
					...
					<ul>
						<li>
							...
							<label class="vam" for="input-CMB-5">
							    账户余额:
								<b style="color:red">&yen;<span><?php echo ($user_money); ?></span></b>
							</label>
							</div>
						</li>
			...
			<div class="order-payment-area">
				...
				<li style="list-style-type:none;:none;margin-bottom:15px;margin-left:15px;">
				<div class="payment-area">
					<input id="input-BJRCB-1" class="radio vam" type="radio" seed="payment_1_8" data-type="1" name="bankName-input" value="alipay">
		...
		<div class="order-payment-action-area"><a class="button-sytle-5" href="<?php echo U('PaymentNow/index',array('order_id'=>$order_id));?>">确认支付</a></div>
    </div>
	<!--订单-表单-支付方式列表结束 -->
