...
<div class="myOrders-area">
    ...
    <div id="myOrders-list-content">
    	...
    	<!--我的订单-订单-套餐 -->
		<?php if(is_array($order_info)): $i = 0; $__LIST__ = $order_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="myOrders-pro-area">
                    ...
                    <tbody>
                        <tr>
                            <td class="tal">
                            	...
                            	&nbsp;&nbsp;&nbsp;&nbsp;
                            	订单时间：<?php echo (date("Y-m-d H:i:s",$vo["order_time"])); ?>
								&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td class="tal">
                                <div class="pro-area clearfix">
                                    <p class="p-img">
                                    	<a title="{$vo.goods_name}" href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" target="_blank">
                                    	<img alt="<?php echo ($vo["goods_name"]); ?>" src="<?php echo ($vo["goods_thumb_img"]); ?>">
                                        
                                    	</a>
                                    </p>
                                    <p class="p-name">
                                    	<a title="<?php echo ($vo["goods_name"]); ?>" target="_blank" href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>"><?php echo ($vo["goods_name"]); ?></a>
                                    </p>
	 ...
	 comment_do.click(function(){
		 ...
		 var order_id=$(this).prev().prev('input[name=order_id]').val();
		  ...
		  if(comment_score<=0){
		   ...
		   $.ajax({
		     'url':"<?php echo U('OrderCenter/doComment');?>",
			 'type':'POST',
			 data:{
			      order_id:order_id,
				  goods_id:goods_id,
...
<div class="mc-menu-area">
	<div class="h">
		<a href="<?php echo U('Member/index');?>" class="button-go-mc" title="个人中心"><span>个人中心</span></a>
	</div>
    <div class="b">
        <ul>
        	<li>
        	<h3>订单中心</h3>
            	<ol>
                	<li id="li-order"  class='current'><a href="<?php echo U('OrderCenter/index');?>" title="我的订单"><span>我的订单</span></a></li>
