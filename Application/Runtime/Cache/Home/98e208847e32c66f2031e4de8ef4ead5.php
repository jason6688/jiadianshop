...
<script src="/jiadianshop/Public/Js/jsapi.js" namespace="ec"></script><!--[if lte IE 6]><script>ol.isIE6=true;</script><![endif]--><!--[if IE 7]><script>ol.isIE7=true;</script><![endif]--><!--[if IE 8]><script>ol.isIE8=true;</script><![endif]-->
<script src="/jiadianshop/Public/Js/jquery-1.js"></script>
<script src="/jiadianshop/Public/Js/ec_002.js"></script> 
<script src="/jiadianshop/Public/Js/ec.js"></script> 
<!--[if lt IE 9]><script src="/jiadianshop/Public/Js/html5shiv.js"></script> <![endif]-->
...
<div class="g">
	<!--搜索-结果数 -->
	<div class="search-count-area"><h1 class="icon-search">搜索<b><?php echo ($keywords); ?></b>共找到商品<em><?php echo ($goods_count); ?></em>件</h1></div>
</div>
<div class="hr-10"></div>
<div class="g search">
        ...
        <div id="ct-list" class="g-l-none search-area">
            <div class="h">
                ...
                <div class="sort-area clearfix">
                    <ul>
                    	<li><b>商品排序：</b></li>
                        <li id="sort-price"><a href="<?php echo U('Search/index',array('keywords'=>$keywords,'order'=>'market_price'));?>" class="sort-price">价格<s></s></a></li>
                        <li id="sort-register_date"><a href="<?php echo U('Search/index',array('keywords'=>$keywords,'order'=>'add_time'));?>" class="sort-added" >上架时间<s></s></a></li>
                    </ul>
                </div>
            </div>
            <div class="b">
				...
				<?php if(is_array($list_goods)): $i = 0; $__LIST__ = $list_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<div>
						<p class="p-img"><a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="{$vo.key_words}>" target="_blank"><img src="<?php echo ($vo["goods_thumb_img"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>"></a></p>
						<p class="p-price"><b>¥<?php echo ($vo["market_price"]); ?></b></p>
						<p class="p-name"><a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["goods_name"]); ?>" target="_blank"><span class="red"><?php echo ($vo["goods_name"]); ?></span></a></p>
						
						  <?php if($vo['is_hot'] == 1): ?><i><img  src="/jiadianshop/Public/Images/1382542488099.png"  style=""></i>
				          <?php elseif($vo['is_new'] == 1): ?>
					              <i><img  src="/jiadianshop/Public/Images/1382542518162.png"  style=""></i>
				           <?php elseif($vo['goods_state'] == '人气'): ?>
				                  <i><img  src="/jiadianshop/Public/Images/1382542555129.png"  style=""></i>
				          <?php elseif($vo['goods_state'] == '首发'): ?>
				                  <i><img  src="/jiadianshop/Public/Images/1382593860805.png"  style=""></i>  
			              <?php else: ?>
					             <i></i><?php endif; ?>
						</div>
